...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('meetings_meetingminutes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meeting', self.gf('django.db.models.fields.related.ForeignKey')(related_name='minutes', to=orm['meetings.Meeting'])),
            ('poster', self.gf('django.db.models.fields.related.ForeignKey')(related_name='minutes', to=orm['auth.User'])),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('meetings', ['MeetingMinutes'])


    def backwards(self, orm):
        # Deleting model 'MeetingMinutes'
        db.delete_table('meetings_meetingminutes')
    ...
    models = {
        ...
        'meetings.meetingminutes': {
            ...
            'meeting': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'minutes'", 'to': "orm['meetings.Meeting']"}),
            'poster': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'minutes'", 'to': "orm['auth.User']"}),
