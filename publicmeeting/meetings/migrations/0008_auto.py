...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming M2M table for field topics on 'Meeting'
        db.rename_table('meetings_meeting_topics', 'meetings_meeting_tags')
        db.create_unique('meetings_meeting_tags', ['meeting_id', 'meetingtopic_id'])


    def backwards(self, orm):
        # Renaming M2M table for field tags on 'Meeting'
        db.rename_table('meetings_meeting_tags', 'meetings_meeting_topics')
