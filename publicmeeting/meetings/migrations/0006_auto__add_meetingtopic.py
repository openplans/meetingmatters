...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MeetingTopic'
        db.create_table('meetings_meetingtopic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('meetings', ['MeetingTopic'])

        # Adding M2M table for field topics on 'Meeting'
        db.create_table('meetings_meeting_topics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meeting', models.ForeignKey(orm['meetings.meeting'], null=False)),
            ('meetingtopic', models.ForeignKey(orm['meetings.meetingtopic'], null=False))
        ))
        db.create_unique('meetings_meeting_topics', ['meeting_id', 'meetingtopic_id'])


    def backwards(self, orm):
        # Deleting model 'MeetingTopic'
        db.delete_table('meetings_meetingtopic')

        # Removing M2M table for field topics on 'Meeting'
        db.delete_table('meetings_meeting_topics')
