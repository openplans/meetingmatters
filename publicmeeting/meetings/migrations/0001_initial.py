...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('meetings_meeting', (
            ('timestampedmodel_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['meetings.TimestampedModel'], unique=True, primary_key=True)),
        ...
        db.create_table('meetings_meeting_speakers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meeting', models.ForeignKey(orm['meetings.meeting'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('meetings_meeting_speakers', ['meeting_id', 'user_id'])

        # Adding M2M table for field attendees on 'Meeting'
        db.create_table('meetings_meeting_attendees', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meeting', models.ForeignKey(orm['meetings.meeting'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('meetings_meeting_attendees', ['meeting_id', 'user_id'])

        # Adding model 'MeetingTag'
        db.create_table('meetings_meetingtag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('meetings', ['MeetingTag'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('meetings_meeting_speakers')

        # Removing M2M table for field attendees on 'Meeting'
        db.delete_table('meetings_meeting_attendees')

        # Deleting model 'MeetingTag'
        db.delete_table('meetings_meetingtag')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 28, 10, 23, 18, 623814)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 28, 10, 23, 18, 623639)'}),
        ...
        'meetings.meeting': {
            'Meta': {'object_name': 'Meeting', '_ormbases': ['meetings.TimestampedModel']},
            ...
            'timestampedmodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['meetings.TimestampedModel']", 'unique': 'True', 'primary_key': 'True'}),
